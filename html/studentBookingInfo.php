...
<body>
  ...
  <main>
    ...
    <div class="main-page">
      <div>
        <?php
        $sql0 = "SELECT * FROM `students` WHERE studentno = $_SESSION[id]";
        $result = mysqli_query($conn, $sql0);
        $stud = mysqli_fetch_assoc($result);
        $sql1 = "SELECT * FROM `programmes` WHERE programmecode ='$stud[programmecode]'";
        ...
        <table>
          ...
          <tr>
            ...
            <td id="coursename" name="coursename"><?php echo $prog['programmetitleenglish'] ?></td>
          </tr>
        </table>
      </div>
      <div>
