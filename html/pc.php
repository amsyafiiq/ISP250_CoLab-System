    ...
    <div class="main-page">
      <div class="table-container">
        <table id="table" class="table hover">
          ...
          <tbody>
            <?php
            $sql0 = "SELECT * FROM `computer` WHERE `lab_ID` = $_GET[labID]";
            $result = mysqli_query($conn, $sql0);
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              echo "<td>$row[comp_RentDue]</td>";
              echo "<td>$row[comp_ReceiveDate]</td>";
              echo "<td>
                      <a id='button' href='../php/pc.php?pcID=$row[lab_ID]'>Edit</a>
                      <a id='button' href='../php/pc.php?pcID=$row[lab_ID]'>Delete</a>
                    </td>";
              $i++;
            }
            ?>
